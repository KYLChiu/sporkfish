...
class SearchMode(Enum):
    NEGA_MAX_SINGLE_PROCESS = "NEGA_MAX_SINGLE_PROCESS"
    NEGA_MAX_LAZY_SMP = "NEGA_MAX_LAZY_SMP"
...
class SearcherConfig(Configurable):
    ...
    :type max_depth: int
    :param search_mode: Search mode (default: SearchMode.NEGA_MAX_SINGLE_PROCESS).
